...
[Boilerplate plugin by @DevinVinson](https://github.com/DevinVinson/WordPress-Plugin-Boilerplate) is a great boilerplate adibing by all the WordPress standards and provides a great structure, but it is troublesome to replace plugin name, slug, file names for so many files each time you want to build a plugin. Boilerplate generator does it all for you with just a few clicks. 
