...
<head>
  ...
  <meta content="Free and Open Source Boilerplate Generator for WordPress plugins" name="description">
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <!-- <h1 class="text-light"><a href="index.php">WP Boilerplate Generator</a></h1> -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            <h1>WordPress Plugin Boilerplate Generator</h1>
            <h2>Easy to use, open source and customizable.</h2>
          </div>
        </div>
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <!-- <img src="assets/img/hero-img.png" class="img-fluid" alt=""> -->
          <form action="generate.php" method="post" class="the_form">
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    <div class="form-group">
                        <label>
                            Plugin Slug: 
                            <input type="text" class="form-control"  name='plugin_slug' placeholder='wc_' required>
                        </label>
                    </div>
                </div>                            
            </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label>
                            Author URL: 
                            <input type="text" class="form-control"  name='author_url' required>
                        </label>
                    </div>
                </div>                            
            </div>
...
<!-- 
    ...
    <div class="container py-4">
      <div class="copyright">
        By <a href='https://pramodjodhani.com'>Pramod Jodhani</a>
      </div>
      <div class="credits">
